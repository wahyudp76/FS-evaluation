...
- **Chart "Performa Biaya per Wilayah"** (gaya sama dengan Performa Waktu/Performance Wilayah): batang horizontal terurut, **angka pada tiap batang**, tooltip berisi komposisi solar/upah/alat untuk metrik Biaya Total. **11 metrik** lewat dropdown: Biaya Total, Biaya Solar, Biaya Upah, Biaya Alat, Rp/Ha, Rp/Jam, Rp/Liter, Rp/Record, % dari Total Biaya, Luas Siram, Solar Terpakai — plus **6 tombol cepat** (Biaya Total, Biaya Solar, Biaya Alat, Rp/Ha, Rp/Liter, % dari Total).
